...
const HeroSection = () => (
  <div className={`m-auto bg-[url(/hero-background.svg)] bg-cover bg-top bg-no-repeat mt-[-28%] w-full h-auto ${inter.className}`}>
    <div className="w-11/12 mx-auto">
      <h1 className="pt-[60%] text-4xl font-semibold tracking-[.08em] text-white">Elevating Talent, Maximizing<br/> Growth</h1>
      <Link href={'./'}>
...
const AboutSection = () => (
  <div className="mb-10 w-11/12 mx-auto bg-[#0A0909]">
    <div className="z-1 absolute right-0 rounded-full bg-[radial-gradient(circle_at_top,_var(--tw-gradient-stops))] from-[#E1040F] to-black w-[25vw] h-[15vh] blur-3xl text-white"></div>
...
const SuccessStoriesSection = () => (
  <div>
    ...
    <div className="bg-[url(/success-story-bg.svg)] bg-cover bg-top bg-no-repeat">
      <h1 className="w-11/12 mx-auto text-center text-5xl font-bold text-white">Victoria</h1>
      <div className="w-11/12 relative mx-auto flex justify-between">
        ...
        <p className="text-center absolute text-sm bottom-10 text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dicta expedita voluptas fuga incidunt natus consectetur similique nisi ex molestias accusamus Lorem ipsum, dolor sit amet consectetur adipisicing.</p>
      </div>
    </div>
  </div>
);
...
const ContactForm = () => (
  ...
  <div className="bg-[url(/contact-bg.svg)] w-[100%] mx-auto bg-cover bg-right-bottom bg-no-repeat h-[80vh] rounded-xl mt-10 ">
    ...
    {({
      ...
      <form action="" className="bg-white rounded-xl w-[90%] mx-auto text-black px-2 mb-5 pb-10">
        ...
        <button className="bg-[#E1040F] px-32 py-2 rounded-lg text-white mt-5 text-base font-semibold flex mx-auto">Submit</button>
      </form>
      )}
    </Formik>
   </div>
  ...
  <div className=" vsm:mt-56 nsm:mt-28">
    <div className="w-full bg-[#131313] text-white">
      ...
      <div className="w-11/12 mx-auto flex justify-between flex-col py-10">
        <div> 
          <h1 className="text-xl font-semibold mb-4 text-white">Open Designers</h1>
          <p className="text-[14px] text-white">Open source is source code that is made freely available for possible modification and redistribution. Products include permission to use the source code, design
      ...
      <div className="w-11/12 mx-auto">
        {/* Quick links */}
        <div className=" flex gap-5 flex-wrap w-[90%] text-white">
