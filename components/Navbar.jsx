...
const Navbar = () => {
  ...
  return (
    ...
    <div className={`flex flex-col md:flex-row rounded-lg absolute md:static md:justify-between items-center md:content-center py-10 text-base transition-all duration-300 w-[92%]  bg-[#180000] ${menuOpen ? "top-[65px]": "translate-y-[-110%]"}`} > 
        ...
        {/* Icons */}
      <div className="flex justify-between w-[60%] mt-36">
